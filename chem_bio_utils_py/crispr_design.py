...
class CRISPRDesign:
  ...
  def initialize_crispr_systems(self):
    ...
    # Repeat expansion and methylation state analysis with nanopore sequencing: https://www.biorxiv.org/content/10.1101/480285v1.full
    cas12a = CRISPR(name='Cas12a', pam_sequence='TTTV', spacer_length=30, for_prefix='CGGCAGCC', for_suffix='GGAAAAAC', rev_prefix='TTAGCGGCTT', rev_suffix='GGCAAAAGAG')
    # Engineering of CRISPR-Cas12b for human genome editing: https://www.nature.com/articles/s41467-018-08224-4#MOESM1
    ...
    # A naturally DNase-free CRISPR-Cas12c enzyme silences gene expression: https://www.sciencedirect.com/science/article/pii/S1097276522003835#mmc3
    cas12c = CRISPR(name='Cas12c', pam_sequence='TTN', spacer_length=30, for_prefix='GCCTGCCCGCAGA', for_suffix='CTTTCCAGTC', rev_prefix='TGGCTGT', rev_suffix='ACCGTAA')
